...
var VoiceroText = {
  ...
  applyDynamicColors: function () {
    ...
    var mainColor = this.websiteColor || "#882be6";
  ...
  loadMessagesFromSession: function () {
    ...
    if (
      ...
      if (
        ...
        if (nonSystemMessages.length === 0) {
          ...
          var sortedMessages = [...nonSystemMessages].sort((a, b) => {
    ...
    if (
      ...
      if (
        ...
        if (messagesContainer) {
          var existingWelcomeMessages = messagesContainer.querySelectorAll(
...
`;
  ...
  updatePopupQuestions: function () {
    ...
    var debugSuggestions = function (container, context) {
      ...
      var initialSuggestions = container.querySelector("#initial-suggestions");
  ...
  setupButtonHandlers: function () {
    ...
    var toggleBtn = shadowRoot.getElementById("toggle-to-voice-chat");
  ...
  collectPageData: function () {
    ...
    // Use the shared utility function or fallback implementation
    var pageData = window.VoiceroPageData
  ...
  isSessionBusy: function () {
    ...
    if (this.isSessionOperationInProgress) {
      ...
      var timeSinceLastOperation = currentTime - this.lastSessionOperationTime;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  var existingInterface = document.getElementById(
    "voicero-text-chat-container"
  );
  if (existingInterface) {
    existingInterface.remove();
